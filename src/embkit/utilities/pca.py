...
def run_pca(input_file: Path | str, pca_size: int, output_file: Path | str | None = None) -> pd.DataFrame:
    ...
    :param pca_size: Number of principal components to compute.
    :param output_file: Optional path to save the PCA result as a CSV file.
    :return: DataFrame containing the PCA-transformed data.
    """
